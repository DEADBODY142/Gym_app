...
class _FormSigninState extends State<FormSignin> {
  ...
  Future<void> _submitForm() async {
    final credentials = await Shared_Preference_Help.getCredentials();
    final mail = credentials['mail'];
    final password = credentials['password'];
    if(mail!=null&&password!=null) {
      if(mail==_emailController.text && password==_passwordController.text)
      {
      Navigator.push(
        context,
